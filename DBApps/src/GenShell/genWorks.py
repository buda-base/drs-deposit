...
def parseArgs(argNamespace):
    ...
    usage='%(prog)s \n[-c CSV outputs csv format to file CSV.\n\t | -d DBApp outputs to db whose parameters are given in config file DBApp ]')
    
    _parser.add_argument("sourceFile",help='CSV file containing Work, HOLLIS tuples (no heading)')
