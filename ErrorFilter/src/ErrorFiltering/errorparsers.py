...
EXIFre = None
'''
edu.harvard.hul.ois.fits.exceptions.FitsToolException NLNZ Metadata Extractor error whil1e harvesting file W1CZ2540-I1CZ2706--I1CZ27060114__0114.jpg 
'''
...
'''
The TIKA errors dont have a work/volume descriptor, so just return the bbconsole path
'''


def TikaParse(errorBead):
	return errorBead.file, errorBead.lineNumber
